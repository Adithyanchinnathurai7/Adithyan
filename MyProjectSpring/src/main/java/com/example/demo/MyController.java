...
public class MyController {
	...
	public ModelAndView processForm(@Valid @ModelAttribute("userobj") User user,HttpServletRequest request,BindingResult result)
	{
		ModelAndView mv=new ModelAndView();
		...
		List<User> a=service.checkUID(user);
	...
	@RequestMapping(method = RequestMethod.POST,value = "/sec")
	public ModelAndView welcome1(HttpServletRequest request) {
		...
		List<User> c=service.checkUser(name, pass);
